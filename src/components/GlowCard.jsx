  ...
  return (
    ...
    >
      ...
      <div className="mb-5 text-center">
        <h2 className={`text-3xl font-semibold inline-block text-transparent bg-clip-text bg-gradient-to-r from-[${card.gradient?.from || '#fff'}] to-[${card.gradient?.to || '#fff'}]`}>{card.company}</h2>
      </div>
      <div className="mb-3">
